...
This exercise is about practicing fetching data and general React programming.

This application will use the GitHub API and the organization names in the included [public/orgs.csv](./public/orgs.csv) file to download information about each organization. If an organization is viewed for over 15 seconds, it fetches a list of public repositories for that organization.
...
2. When the `App` component is first rendered, `fetch` the included `orgs.csv`
